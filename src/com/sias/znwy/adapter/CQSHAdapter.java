...
public class CQSHAdapter extends AbstractBaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.itemParent = (TextView) convertView.findViewById(R.id.itemParent);
			holder.itemSource = (TextView) convertView.findViewById(R.id.itemSource);
			holder.itemState = (TextView) convertView.findViewById(R.id.itemState);
		...
		holder.itemState.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				RadioOnClick radioOnClick = new RadioOnClick(1, holder.itemState, m_itemState);
				AlertDialog ad = new AlertDialog.Builder(context).setSingleChoiceItems(m_itemState, radioOnClick.getIndex(), radioOnClick)
						.create();
		...
		holder.itemType.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ListView areaRadioListView;
				RadioOnClick radioOnClick = new RadioOnClick(1, holder.itemState, m_itemState);
				AlertDialog ad = new AlertDialog.Builder(context).setSingleChoiceItems(m_itemType, radioOnClick.getIndex(), radioOnClick)
						.create();
				ad.requestWindowFeature(Window.FEATURE_NO_TITLE);
				areaRadioListView = ad.getListView();
				ad.show();
		...
		holder.itemParent.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ListView areaRadioListView;
				RadioOnClick radioOnClick = new RadioOnClick(1, holder.itemState, m_itemParent);
				AlertDialog ad = new AlertDialog.Builder(context).setSingleChoiceItems(m_itemParent, radioOnClick.getIndex(), radioOnClick)
						.create();
				ad.requestWindowFeature(Window.FEATURE_NO_TITLE);
				areaRadioListView = ad.getListView();
				ad.show();
		...
		// android.R.layout.simple_spinner_item, m_itemParent);
		// adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		// holder.itemParent.setAdapter(adapter);
		// ArrayAdapter<String> itemTypeAdapter = new
		...
		// }
		//
		// ArrayAdapter<String> itemStateAdapter = new
		// ArrayAdapter<String>(mContext, android.R.layout.simple_spinner_item,
		// m_itemState);
		// adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		...
		// holder.itemType.setOnItemSelectedListener(new
		...
		// }
		// });
		// holder.itemState.setOnItemSelectedListener(new
		// OnItemSelectedListener() {
		//
		// @Override
		// public void onItemSelected(AdapterView<?> parent, View view, int
		...
		// }
		// });
		// holder.itemParent.setOnItemSelectedListener(new
		// OnItemSelectedListener() {
		//
		// @Override
		// public void onItemSelected(AdapterView<?> parent, View view, int
