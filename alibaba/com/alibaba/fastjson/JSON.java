...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    @SuppressWarnings("unchecked")
    private static final <T extends IWebBeanParam> T parseObject(String text, Class<T> clazz, Feature... features) {
        return (T) parseObject(text, (Type) clazz, ParserConfig.getGlobalInstance(), DEFAULT_PARSER_FEATURE, features);
    }

//    @SuppressWarnings("unchecked")
//    public static final <T extends IWebBeanParam> T parseObject(String input, Type clazz, Feature... features) {
//        return (T) parseObject(input, clazz, ParserConfig.getGlobalInstance(), DEFAULT_PARSER_FEATURE, features);
//    }

    @SuppressWarnings("unchecked")
    public static final <T extends IWebBeanParam> T parseObject(String input, Type clazz, int featureValues, Feature... features) {
        if (input == null) {
            return null;
        }
    ...
    public static final <T extends IWebBeanParam> T parseObject(String text, Class<T> clazz) {
    ...
    public static final <T extends IWebBeanParam> List<T> parseArray(String text, Class<T> clazz) {
    	return parseArrayObject(text, clazz);
    }
    
    public static final List<Long> parseLongArray(String text) {
    	return parseArrayObject(text, Long.class);
    }

    private static final <T> List<T> parseArrayObject(String text, Class<T> clazz) {
        if (text == null) {
            return null;
        }
    ...
    public static final String toJSONString(IWebBeanParam object) {
        return toJSONString(object, new SerializerFeature[0]);
    }
    
    public static final String toJSONString(List<?> object) {
        return toJSONString(object, new SerializerFeature[0]);
    }
